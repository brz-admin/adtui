...
MESSAGES = {
    ...
    "ACCOUNT_NOT_DISABLED": "Account is not currently disabled",
    "ENABLE_SUCCESS": "Successfully enabled user account",
    "ENABLE_FAILED": "Failed to enable account: {error}",
    "ENABLE_USER_ONLY": "Enable can only be performed on user accounts",
    "ACCOUNT_NOT_ENABLED": "Account is not currently enabled",
    "DISABLE_SUCCESS": "Successfully disabled user account",
    "DISABLE_FAILED": "Failed to disable account: {error}",
    "DISABLE_USER_ONLY": "Disable can only be performed on user accounts",
